...
from yunwei_win.db import ensure_ingest_job_tables_for, get_session
...
from yunwei_win.services.ingest.auto_confirm import (
    AutoConfirmResult,
    commit_auto_extraction,
)
from yunwei_win.services.ingest.business_card import ingest_business_card
from yunwei_win.services.ingest.contract import (
    MatchCandidate,
    commit_contract_extraction,
    extract_contract_draft,
)
from yunwei_win.services.ingest.progress import ProgressCallback
...
from yunwei_win.services.ingest.wechat import ingest_wechat_screenshot
...
# The worker (yunwei_win.workers.ingest_rq) reads the IngestJob row, runs
