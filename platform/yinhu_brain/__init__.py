"""yinhu_brain — 客户档案智能整理后端,作为 Python 模块集成进 platform。
...
Usage from platform_app::
    ...
    from yinhu_brain import router as yinhu_router
    app.include_router(yinhu_router, prefix="/win/api")

Per-enterprise database isolation: see ``yinhu_brain.db`` — each enterprise
