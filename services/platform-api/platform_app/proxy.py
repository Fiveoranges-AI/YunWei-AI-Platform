"""HMAC reverse proxy for legacy customer-agent entrypoints."""
...
from .response_headers import (
    ...
    make_csp_nonce,
    sanitize_agent_response_headers,
)
...
async def reverse_proxy(
    request: Request, *, client_id: str, agent_id: str, user: dict, subpath: str
) -> StreamingResponse:
    ...
    auth_headers = hmac_sign.sign(
        secret=tenant["hmac_secret_current"],
        key_id=tenant["hmac_key_id_current"],
