...
export const dashboardAlerts: RiskAlert[] = [
  ...
  },
  {
    ...
    body: "其中 2 条置信度 < 80%（T3 调拨 62% · AL80 盘点 70%），已挂复核队列 · 王主管 / 张仓管手机收到提醒。",
  },
];

// ---- KPI (iter G9: 7→4 关键卡片) ----
...
export const ledgerRows = [
  { time: "2026-05-19 10:18", op: "出库", sku: "JT-HLZ-230-114-65", name: "高铝砖", delta: "-1,500", before: 5780, after: 4280, ref: "SO-20260518-007 · 宜兴华能", user: "张仓管", note: "", confidence: 98, confirmed: true },
  { time: "2026-05-19 09:45", op: "出库", sku: "JT-MLS-M70", name: "莫来石砖", delta: "-200", before: 520, after: 320, ref: "SO-20260517-012 · 常州新材", user: "李师傅", note: "部分出库 · 余 50 待补", confidence: 86, confirmed: false },
...
export type ShortageOrder = {
  ...
  aiSuggestion: string;
  fulfillment: string; // 预计可发货状态：可全发 / 可部分发 X% / 需补产 / 无法发货
  fulfillmentPct: number; // 0-100，用于进度条
};
...
export const shortageOrders: ShortageOrder[] = [
  {
    id: "SO-20260519-001",
    customer: "江苏宏泰工程有限公司",
    deliveryDate: "2026-05-22 (周五，2 天后)",
    level: "urgent",
    totalValue: "¥38,600",
    items: [
    ...
    fulfillment: "需补产 · 仅 JT-JZL-JC18-LR 可发",
    fulfillmentPct: 23,
  },
  {
    id: "SO-20260519-002",
  ...
  sections: [
    {
      title: "1. 今日流水",
      items: [
        "入库 18 笔 / 出库 23 笔 · 净流入 +1,040",
        "下游订单 7 个 · 7 日内待发 12 笔",
      ],
    },
    {
      title: "2. 风险与异常",
      items: [
        "🔴 SO-20260519-001 江苏宏泰 浇注料 JC-16 完全缺货（缺 200 袋）",
        "🟡 M70 莫来石 / AL90 高纯刚玉 低于安全线",
        "C-01 盘点差 +12 块 / SO-20260517-012 部分出库 36 小时无跟进",
      ],
    },
    {
      title: "3. AI 补产建议",
      items: [
        "JC-16 400 袋（5/22）· M70 600 块（5/23）· AL90 250 块（5/26）",
        "合计 1,250 单位 → 已挂工艺组",
      ],
    },
    {
    ...
    },
    {
      title: "5. 操作绩效",
      items: [
        "王主管 12 入库 100% 合规 · 张仓管 1 笔 +12 偏差待复核 · 李师傅 1 笔部分出库待跟",
      ],
    },
  ],
};
